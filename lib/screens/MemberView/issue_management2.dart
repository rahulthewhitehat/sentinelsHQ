...
class ViewIssuesScreen2 extends StatefulWidget {
  const ViewIssuesScreen2({super.key});

  @override
  _ViewIssuesScreen2State createState() => _ViewIssuesScreen2State();
}

class _ViewIssuesScreen2State extends State<ViewIssuesScreen2> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Submit Issue / Feedback'),
        actions: [
        ],
      ),
      body: StreamBuilder<QuerySnapshot>(
        stream: isAdminOrSuperAdmin
            ? FirebaseFirestore.instance
            .collection('issues')
            ...
            : FirebaseFirestore.instance
            .collection('issues')
            .where('raisedByUid', isEqualTo: currentUserUid)
            .orderBy('timestamp', descending: true)
            .snapshots(),
