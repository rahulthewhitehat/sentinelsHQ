...
class _EventCalendarScreenState extends State<EventCalendarScreen> {
  ...
  Future<void> _confirmDelete(BuildContext context, String eventId, String eventName) async {
          ...
          return CupertinoAlertDialog(
            ...
            actions: <Widget>[
              ...
              CupertinoDialogAction(
                ...
                onPressed: () {
                  Navigator.of(context).pop();
                  Provider.of<EventProvider>(context, listen: false).deleteEvent(eventId);
                },
              ),
            ],
          );
                        ...
                        Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () => _showEventDialog(context, event: event),
                            ),
                            IconButton(
                              icon: const Icon(Icons.delete, color: Colors.red),
                              onPressed: () => _confirmDelete(context, event["id"], event["name"]),
                            ),
                          ],
                        ),
                      ],
